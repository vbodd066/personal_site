...
export default function Hero() {
  return (
    <section
      className="relative mb-16 pt-32 pb-16 overflow-visible min-h-screen" style={{background: 'transparent',}}>
      ...
      <div className="relative">
        ...
        <h1 className="text-8xl sm:text-8xl md:text-8xl font-bold text-gray-900 mb-4 z-10 mt-0 text-right mr-70 sm:ml-140 md:ml-140">
          <span
            ...
            style={{backgroundImage: `linear-gradient(to right, var(--accent-dark), var(--accent-primary), var(--accent-dark))`, backgroundClip: 'text', WebkitBackgroundClip: 'text'}}>
            Victor Boddy
          </span>
        </h1>
        ...
        {/* Buttons for Get in Touch and LinkedIn Profile */}
        <div className="flex flex-wrap gap-4 justify-center mb-8 relative z-10 text-center">
          <a
            ...
            style={{background: `linear-gradient(to right, var(--accent-dark), var(--accent-primary))`}}>
            Get In Touch
          </a>
          <a
            ...
            style={{ borderColor: 'var(--accent-primary)',color: 'var(--accent-primary)',backgroundColor: 'transparent'}} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'var(--accent-light)'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
            LinkedIn Profile
          </a>
        </div>
      </div>
